...
- it's in general a CSS library which is very suitable for writing UI components, thanks to its powerful API (see for example the [Recipes API](https://vanilla-extract.style/documentation/recipes-api/))
